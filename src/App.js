...
const StudentComponent = React.lazy(() => import('./components/students/StudentComponent'));
const CoursesComponent = React.lazy(() => import('./components/CoursesComponent'));
const DelibirationComponent = React.lazy(() => import('./components/DelibirationComponent'));
